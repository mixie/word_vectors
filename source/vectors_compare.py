...
parser.add_argument('weights', nargs=1, help='weight file number')
...
# for model with selected ngrams
...
# compare our results to given dataset
...
# run compare alg.
model.load_weights('weights_'+str(weights)+'.h5')
weights = None
